...
class Googlemaps {
  ...
  var $apiKey						= 'AIzaSyBchRI_21q70ikqLxY-SxgiRJUY6BWMav8'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
