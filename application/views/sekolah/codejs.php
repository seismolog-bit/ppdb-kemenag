    ...
    var t = $("#mytable").DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            "data": "id_sekolah",
                            "orderable": false
                        },{"data": "npsn_sekolah","className" : "text-center"},
                            {"data": "asal_sekolah"},
                            // {"data": "alamat_sekolah"},
                            // {"data": "kelurahan"},
                            {"data": "status_sekolah","className" : "text-center"},
                            {"data": "kecamatan"},
                        {
                            "data" : "action",
                            "orderable": false,
                    ...
                    rowCallback: function(row, data, iDisplayIndex) {
                        ...
                        var stt = data.status_sekolah;
                        if (stt=="NEGERI"){
                            $('td:eq(4)', row).html('<span class="label label-success">NEGERI</span>');
                        } else if (stt=="SWASTA"){
                            $('td:eq(4)', row).html('<span class="label label-warning">SWASTA</span>');
                        }
                    }
                });
